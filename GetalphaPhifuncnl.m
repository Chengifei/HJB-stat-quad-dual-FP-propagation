function [alphav,Phibarst,Phibarstp,Dssig,Dpsigs,alpha0v]=...
    GetalphaPhifuncnl(M0,c1,x,t1v,first,alphastartv,funcparams,whichmethod)
%
...
%  alpha0v - the term that contained x and is constant indep of the
...
%  Phibarst - state-trans matrix for $\Abar$ from t to s
...
% matrices.
%
Phibarst=zeros(2,2,ntp1,ntp1);
Phibarstp=zeros(2,2,ntp1,ntp1);
for it0=1:ntp1
  for it1=1:ntp1
      ct0t1=cos(t1v(1,it1)-t0v(1,it0));
      st0t1=sin(t1v(1,it1)-t0v(1,it0));
      Phibarst(:,:,it1,it0)=[ct0t1, st0t1;...
          -st0t1, ct0t1];
...
plotalp=0;
if plotalp==1
  'Plotting from within GetalphaPhifuncnl.'
  figure;
  plot(t1v,alphav);
end;